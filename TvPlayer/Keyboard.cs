...
namespace TvPlayer
{
    ...
    class GlobalKeyboardHook : IDisposable
    {
        ...
        public GlobalKeyboardHook(Keys[] registeredKeys = null)
        {
            ...
            hookProcDelegate = new keyboardHookProc(LowLevelKeyboardProc); // we must keep alive _hookProc, because GC is not aware about SetWindowsHookEx behaviour.
            ...
            _windowsHookHandle = SetWindowsHookEx(WH_KEYBOARD_LL, hookProcDelegate, _user32LibraryHandle, 0);
        ...
        static extern IntPtr SetWindowsHookEx(int idHook, keyboardHookProc lpfn, IntPtr hMod, int dwThreadId);
